...
let banderas = ["MUNCH.jpg", "PC.jpg", "ve.jpg", "vlz.jpg", "bot.jpg"];
...
opciones.push(["Francisco de Goya", "Rembrandt", "Edvard Munch"]);
opciones.push(["Frida Kahlo", "Salvador Dalí", "Pablo Picasso"]);
opciones.push(["Jackson Pollock", "Johannes Vermeer", "Claude Monet"]);
opciones.push(["Fernando Botero", "Diego Velázquez", "Paul Cézanne"]);
opciones.push(["Sandro Botticelli", "Miguel Ángel", "ETIOPIA"]);
